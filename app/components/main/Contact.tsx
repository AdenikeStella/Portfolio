...
export default function Contact() {
    return (
        <section id="contact" className="relative min-h-screen flex flex-col overflow-hidden px-5 md:px-15 pt-30 md:py-30 py-5" style={{ borderTop: 'solid 1px var(--faint)' }}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-0">
                <div className="flex flex-col gap-4">
                    ...
                    <div className="flex mt-0 mb-7.5">
                        <h1 className=" font-extrabold text-white" style={{ fontFamily: 'var(--font-syne)', fontSize: 'clamp(48px, 5vw, 80px)', letterSpacing: '-3px', lineHeight: '0.95' }}>Let's  <br /> work<br /><span className="font-normal text-5xl md:text-7xl text-[#0057ff] " style={{ fontFamily: 'var(--font-instrument-serif)', fontStyle: 'italic' }}> together.</span>
                        </h1>
                    </div>
                ...
                {/* Contact form */}
                <div className="relative flex flex-col gap-5 items-center justify-center mt-3 md:px-5">
                    {/* email */}
